...
public class Expertlevelfour extends State{
    ...
    public static String[] question={"What will be the Output?","System.out.println(\"Java\".substring(1, 3));"};
    public static String[] question2={"What will be the Output?","System.out.println(\"Java\" + 1 + 2);"};
    public static String[] question3 ={"What will be the Output?","System.out.println(9 + 11 + \"24\");"};
    public static String[] question4 = {"What does IoT stand for?;"};
    public static String[] question5 = {"What will be the Output?","System.out.println(10 > 5 && (2 + 3) < 6);"};
    ...
    public static String[] fanswer = {"av","Java12","2024","Internet of Things","true"};
  ...
  public static int countdown = 15,count = 1;
    ...
    public Expertlevelfour(Games game) {
        super(game);
