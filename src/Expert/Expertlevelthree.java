...
public class Expertlevelthree extends State{
    ...
    public static String[] question={"What does System.out.println( !(10 == 5) ); print?"};
    public static String[] question2={"What is the result of ","System.out.println(\"hello\".substring(1, 3));?"};
    public static String[] question3 ={"What does GUI stand for?"};
    public static String[] question4 = {"What will be the Output?","System.out.println(\"pineapple\".substring(4));"};
    public static String[] question5 = {"What will be the Output?","System.out.println(Math.abs(-5));"};
    ...
    public static String[] fanswer = {"true","el","Graphical User Interface","apple","5"};
   ...
   public static int wrongcount = 0;
    ...
    public Expertlevelthree(Games game) {
        super(game);
    ...
    public void draw(Graphics g){
        ...
        if(next == true){
        g.drawString(question[0], 330, 470);
