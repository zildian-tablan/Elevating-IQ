...
public class Expertlevelone extends State{
    ...
    public static String[] question={"What will be the Output?","System.out.println(\"5\"+3);"};
    public static String[] question2={"What does \"HTML\" stand for?"};
    public static String[] question3 ={"What does \"SMTP\" stand for?"};
    public static String[] question4 = {"What will be the Output?","System.out.println(\"3+5\");"};
    public static String[] question5 = {"What is the result of System.out.println(9 % 4);?"};
    ...
    public static String[] fanswer = {"53","Hypertext Markup Language","Simple Mail Transfer Protocol","3+5","1"};
   ...
   public static int wrongcount = 0;
    ...
    public Expertlevelone(Games game) {
        super(game);
