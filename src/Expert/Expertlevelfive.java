...
public class Expertlevelfive extends State{
    ...
    public static String[] question={"What will be the Output?","System.out.println(5 == 5 && 5 == 6 || 6 == 6);"};
    public static String[] question2={"What does CRUD stand for in database ","management?"};
    public static String[] question3 ={"What will be the Output?","System.out.println(\"Java\".equals(\"java\"));"};
    public static String[] question4 = {"What will be the Output?","System.out.println(\"hello\".length() + ","\"world\".length());"};
    public static String[] question5 = {"What will be the Output?","System.out.println(\"Hello World!!!\");"};
    ...
    public static String[] fanswer = {"true","Create, Read, Update, Delete","false","10","Hello World!!!"};
    public static String[] sanswer={"Create Read Update Delete"};
     public static String[] tanswer={"Create,Read,Update,Delete"};
   ...
   public static int wrongcount = 0;
    ...
    public Expertlevelfive(Games game) {
        super(game);
    ...
    public void draw(Graphics g){
        ...
        QCountdown();
         ...
         g.drawString(question2[0], 315, 470);
         g.drawString(question2[1], 315, 490);
     ...
     if(count == 2){
        ...
        QCountdown();
         ...
         g.drawString(question4[2], 315, 510);
         if(count == 4){
        QCountdown();
        }
        }else if(next5 == true){
             ...
             if(sbutton.isMousePressed()){
                 ...
                 if(panswer.equalsIgnoreCase(fanswer[0])){
                    ...
                    oscore=Integer.toString(score);
                     ...
                     if(panswer.equalsIgnoreCase(fanswer[1])||panswer.equalsIgnoreCase(sanswer[0])||panswer.equalsIgnoreCase(tanswer[0])){
                    game.getAudioPlayer().answerCorrect();
                         player.changeypos(-50);
                       score +=100;
                    oscore=Integer.toString(score);
