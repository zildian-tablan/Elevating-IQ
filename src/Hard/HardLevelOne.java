...
public class HardLevelOne extends State{
    ...
    public static String[] question={"It is an example of every Java Class"};
    public static String[] question2={"Method ___ should have the same return ","type and arguments"};
    public static String[] question3 ={"In Java,How many super class can ","your inherited subclass have"};
    public static String[] question4 = {"A bar that displays the progress of specific task"};
    public static String[] question5 = {"A Text inside a container"};
    ...
    public static String[] fanswer = {"encapsulation","overriding","one","JProgressBar","JLABEL"};
    public static String[] sanswer={"1"};
   ...
   public static int wrongcount = 0;
    ...
    public HardLevelOne(Games game) {
        super(game);
    ...
    public void draw(Graphics g){
        ...
        if(next == true){
        g.drawString(question[0], 370, 470);
          if(count == 1){
        QCountdown();
        }
        }else if(next2 == true){
        ...
        QCountdown();
         ...
         g.drawString(question4[0], 340, 470);
           if(count == 4){
        QCountdown();
        }
        }else if(next5 == true){
         g.drawString(question5[0], 390, 470);
           if(count == 5){
        QCountdown();
        }
        }else if(next6 == true){
             ...
             if(sbutton.isMousePressed()){
                 ...
                 if(panswer.equalsIgnoreCase(fanswer[0])){
                    ...
                    oscore=Integer.toString(score);
                     ...
                     if(panswer.equalsIgnoreCase(fanswer[2]) || panswer.equalsIgnoreCase(sanswer[0])){
                         Playing.power = 1;
                         game.getAudioPlayer().answerCorrect();
                     player.changeypos(-50);
                       score +=100;
