...
public class HardLevelTwo extends State{
    ...
    public static String[] question={"It makes multimedia application attractive"};
    public static String[] question2={"All multimedia production had some of it?"};
    public static String[] question3 ={"It is the process of making ststaic image","look like it's moving"};
    public static String[] question4 = {"Component of multimedia that uses speech etc."};
    public static String[] question5 = {"It give a lot of information in small time duration"};
    ...
    public static String[] fanswer = {"graphics","text","animation","audio","video"};
   ...
   public static int wrongcount = 0;
    ...
    public HardLevelTwo(Games game) {
        super(game);
