...
public class HardLevelThree extends State{
    ...
    public static String[] question={"A ____ is passive entity"};
    public static String[] question2={"It is the simplest process model."};
    public static String[] question3 ={"It is when a process is currently using the CPU"};
    public static String[] question4 = {"The simplest CPU – scheduling algorithm."};
    public static String[] question5 = {"Priority Scheduling can be preemptive or non __"};
    ...
    public static String[] fanswer = {"program","two-state","running","FCFS","preemptive"};
    public static String[] sanswer={"two state","first come,first served"};
   ...
   public static int wrongcount = 0;
    ...
    public HardLevelThree(Games game) {
        super(game);
    ...
    public void draw(Graphics g){
        ...
        if(next == true){
        g.drawString(question[0], 390, 470);
         if(count == 1){
        QCountdown();}
        }else if(next2 == true){
         g.drawString(question2[0], 370, 470);
       //  g.drawString(question2[1], 350, 490);
        if(count == 2){
        QCountdown();}
        }else if(next3 == true){
         g.drawString(question3[0], 345, 470);
        ...
        QCountdown();}
         ...
         g.drawString(question5[0], 330, 470);
          if(count == 5){
        QCountdown();}
        }else if(next6 == true){
            changeXpos();
             ...
             if(sbutton.isMousePressed()){
                 ...
                 if(panswer.equalsIgnoreCase(fanswer[0])){
                    ...
                    oscore=Integer.toString(score);
                     ...
                     if(panswer.equalsIgnoreCase(fanswer[1]) || panswer.equalsIgnoreCase(sanswer[0])){
                         game.getAudioPlayer().answerCorrect();
                     player.changeypos(-50);
                       score +=100;
                    oscore=Integer.toString(score);
                    ...
                    oscore=Integer.toString(score);
                     ...
                     if(panswer.equalsIgnoreCase(fanswer[3])|| panswer.equalsIgnoreCase(sanswer[1])){
                         Playing.power = 1;
                         game.getAudioPlayer().answerCorrect();
                     player.changeypos(-50);
                       score +=100;
