...
public class HardLevelFive extends State{
    ...
    public static String[] question={"Describes how HTML elements are to be ","displayed"};
    public static String[] question2={"Ways to insert CSS where you apply a unique","style for a single element."};
    public static String[] question3 ={"Ways to insert CSS where you apply a unique","style on a single HTML page"};
    public static String[] question4 = {" A CSS selector that uses the id attribute of","an HTML element to select a specific element."};
    public static String[] question5 = {"A CSS selector that uses (*) to select all","HTML elements on the page."};
    ...
    public static String[] fanswer = {"CSS","Inline Style","Internal Style","Class selector","universal selector"};
    public static String[] sanswer={"Cascading Style Sheets","Inline","Internal","class","universal"};
   ...
   public static int wrongcount = 0;
    ...
    public HardLevelFive(Games game) {
        super(game);
             ...
             if(sbutton.isMousePressed()){
                 ...
                 if(panswer.equalsIgnoreCase(fanswer[0]) || panswer.equalsIgnoreCase(sanswer[0])){
                    ...
                    oscore=Integer.toString(score);
                     ...
                     if(panswer.equalsIgnoreCase(fanswer[1]) || panswer.equalsIgnoreCase(sanswer[1])){
                         game.getAudioPlayer().answerCorrect();
                     player.changeypos(-50);
                       score +=100;
                    oscore=Integer.toString(score);
                     ...
                     if(panswer.equalsIgnoreCase(fanswer[2]) || panswer.equalsIgnoreCase(sanswer[2])){
                         Playing.power = 1;
                         game.getAudioPlayer().answerCorrect();
                     player.changeypos(-50);
                       score +=100;
                    oscore=Integer.toString(score);
                     ...
                     if(panswer.equalsIgnoreCase(fanswer[3]) || panswer.equalsIgnoreCase(sanswer[3])){
                         game.getAudioPlayer().answerCorrect();
                     player.changeypos(-50);
                       score +=100;
                    oscore=Integer.toString(score);
                     ...
                     if(panswer.equalsIgnoreCase(fanswer[4]) || panswer.equalsIgnoreCase(sanswer[4])){
                         game.getAudioPlayer().answerCorrect();
                     player.changeypos(-50);
                       score +=100;
                    oscore=Integer.toString(score);
