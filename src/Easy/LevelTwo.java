...
public class LevelTwo extends State {
    ...
    String[] question1 = {"To achieve encapsulation,declare the class ","variable as ______."};
    String[] question2 = {"It is the process that enables one class to acquire.",
                          "public methods and variables to another ______."};
    String[] question3 = {"Constructor with Parameter is called _____",
                         " Constructor."};
    String[] question4 = {"The class where we will inherit."};
    String[] question5 = {"The class that will inherit."};
    String[] choices = {"PUBLIC","PROTECTED","PRIVATE","STATIC"};
    String[] choices2 = {"POLYMORPHISM","INHERITANCE","ENCAPSULATION","ABSTARCTION"};
    String[] choices3 ={"PARAMETERIZED","DEFAULT","NO-ARG","ANONYMOUS"};
    String[] choices4 ={"SUBCLASS","SUPERCLASS","NOCLASS","HIGHCLASS"};
    String[] choices5 ={"NOCLASS","SUPERCLASS","SUBCLASS","HIGHCLASS"};
    String[] answer = {"PRIVATE","INHERITANCE","PARAMETERIZED","SUPERCLASS","SUBCLASS"};
    ...
    public LevelTwo(Games game,Playing playing) {
        super(game);
