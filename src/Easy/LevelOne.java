...
public class LevelOne extends State {
    ...
    String[] question1 = {"What is the top-level window that holds other ","Swing user interface?"};
    String[] question2 = {"It is an organized collection of structured",
                          "information or data stored in a computer system?"};
    String[] question3 = {"The ____ of an object is defined by set of methods."};
    String[] question4 = {"A Java Class uses objects to define data fields."};
    String[] question5 = {"It translates API calls into operations for",
                          "specific database"};
    String[] choices = {"JFRAME","JPANEL","JFRAMES","JPANELS"};
    String[] choices2 = {"INFORMATION","DATA","SQL","DATABASE"};
    String[] choices3 ={"STATE","METHOD","BEHAVIOR","OBJECT"};
    String[] choices4 ={"TRUE","FALSE","IT DEPENDS","NEXT QUESTION"};
    String[] choices5 ={"DRIVER MANAGER","DRIVER","METADATA","STATEMENT"};
    String[] answer = {"JFRAME","DATABASE","BEHAVIOR","FALSE","DRIVER"};
    ...
    public LevelOne(Games game,Playing playing){
