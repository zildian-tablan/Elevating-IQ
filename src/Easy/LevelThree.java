...
import static utilz.Constants.UI.EchoiceButtons.ECB_HEIGHT;
import static utilz.Constants.UI.EchoiceButtons.ECB_WIDTH;
...
public class LevelThree extends State{
    ...
    String[] question1 = {"It is one implementation with different methods."};
    String[] question2 = {"This manager divides a container into five areas: ",
                         "East, South, West, North, and Center."};
    String[] question3 = {"These classes contain methods for adding and " ,
        "removing objects as well as ways to iterate" , " through them."};
    String[] question4 = {" System.out.println(\"\")",
                          "What is the error?"}; 
    String[] question5 = {"What are the two value of a boolean?"};
    String[] choices = {"INHERITANCE","OVERRIDING","POLYMORPHISM","OVERLOADING"};
    String[] choices2 = {"BORDERLAYOUT","FLOWLAYOUT","GRIDLAYOUT","COMPASSLAYOUT"};
    String[] choices3 ={"STORAGE","WINDOW","CONTAINER","TOP"};
    String[] choices4 ={"System","out","println","EVERYTHING"};
    String[] choices5 ={"0,1","YES,NO","OK,CANCEL","TRUE,FALSE"};
    String[] answer = {"POLYMORPHISM","BORDERLAYOUT","CONTAINER","EVERYTHING","TRUE,FALSE"};
    ...
    public LevelThree(Games game,Playing playing){
        super(game);
...
//        g.drawString(question1[1],430,490);
       ...
       g.drawString(question3[0], 320, 470);
        g.drawString(question3[1],320,490);
        g.drawString(question3[2],320,510);
