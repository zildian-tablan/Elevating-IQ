...
public class LevelFour extends State{
    ...
    String[] question1 = {"The_______ of an object is defined by a set","of methods"};
    String[] question2 = {"Special kind of methods that are invoked","   to construct objects"};
    String[] question3 = {"Constructor without Parameter ","   is called __ Constructor"};
    String[] question4 = {"It is also known as Data hiding"};
    String[] question5 = {"Occurs when there is a hierarchy of classes" ," related to each through inheritance"};
    String[] choices = {"STATE","VARIALBLES","BEHAVIOR","DATA"};
    String[] choices2 = {"CONSTRUCTOR","OBJECT","CLASS","DATA FIELDS"};
    String[] choices3 ={"NO-ARG","DEFAULT","PARAMETERIZED","ANONYMOUS"};
    String[] choices4 ={"ENCAPSULATION","POLYMORPHISM","INHERITANCE","ABSTRACTION"};
    String[] choices5 ={"ENCAPSULATION","POLYMORPHISM","INHERITANCE","ABSTRACTION"};
    String[] answer = {"BEHAVIOR","CONSTRUCTOR","NO-ARG","ENCAPSULATION","POLYMORPHISM"};
    ...
    public LevelFour(Games game,Playing playing) {
        super(game);
