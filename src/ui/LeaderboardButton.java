...
import static utilz.Constants.UI.LeaderButtons.*;
...
public class LeaderboardButton {
    ...
    public LeaderboardButton(int xPos,int yPos,int rowIndex,Gamestate state){
        this.xPos = xPos;
        this.yPos = yPos;
    ...
    private void loadImgs() {
     ...
     BufferedImage temp = LoadSave.GetSpriteAtlas(LoadSave.Leaderboard_Buttons);
